...
<head>
  ...
  <script type="text/javascript">
    ...
    if(type != 'pc')  window.location.replace(window.location.origin + "/1.html");
  </script>
			...
			<div class="row">
				...
				<div class="col-md-5">
					<div class="banner-body-content">
						<h2><?php echo e(config('sys.web.name','网站首页'))); ?></h2>
...
</html><?php /**PATH /home/ftp/s/ser177390476772/ym/src/resources/views/index.blade.php ENDPATH**/ ?>