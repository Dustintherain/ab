...
<header class="navbar navbar-expand flex-md-row bd-navbar">
    <div class="navbar-nav-scroll">
        <ul class="navbar-nav bd-navbar-nav flex-row">
            ...
            <li class="nav-item">
                <a class="nav-link nav-logo-name d-none d-sm-block" href="/"><i class="fa fa-cloud"></i> 灵空源码
                    V1.0</a>
...
</html><?php /**PATH /home/ftp/s/ser177390476772/ym/src/resources/views/admin/layout/index.blade.php ENDPATH**/ ?>